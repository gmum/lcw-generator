...
python -O -m train_generator --dataroot /shared/sets/datasets/vision/ --model cwg_dynamic --dataset mnist --monitor frechet_inception_distance --noise_dim 32 --batch_size 256 --lr 0.0005 --gpus 1 --check_val_every_n_epoch 25 --progress_bar_refresh_rate 100 --patience 5
python -O -m train_generator --dataroot /shared/sets/datasets/vision/ --model cwg_fixed --dataset mnist --monitor frechet_inception_distance --noise_dim 32 --batch_size 256 --lr 0.0005 --gpus 1 --check_val_every_n_epoch 25 --progress_bar_refresh_rate 100 --patience 5 --gamma 0.01160
python -O -m train_generator --dataroot /shared/sets/datasets/vision/ --model swg5000 --dataset mnist --monitor frechet_inception_distance --noise_dim 32 --batch_size 256 --lr 0.0005 --gpus 1 --check_val_every_n_epoch 25 --progress_bar_refresh_rate 100 --patience 5
